...
public:
  TrackletEngine(string name, unsigned int iSector) : ProcessBase(name, iSector) {
    ...
    if (layer1_ == 1 && layer2_ == 2)
      iSeed_ = 0;
    else if (layer1_ == 3 && layer2_ == 4)
      iSeed_ = 2;
    else if (layer1_ == 5 && layer2_ == 6)
      iSeed_ = 3;
    else if (disk1_ == 1 && disk2_ == 2)
      iSeed_ = 4;
    else if (disk1_ == 3 && disk2_ == 4)
      iSeed_ = 5;
    else if (disk1_ == 1 && layer2_ == 1)
      iSeed_ = 6;
    else if (disk1_ == 1 && layer2_ == 2)
      iSeed_ = 7;
    else if (layer1_ == 1 && disk2_ == 1)
      iSeed_ = 6;
    else if (layer1_ == 2 && disk2_ == 1)
      iSeed_ = 7;
  ...
  void execute() {
    if (!((doL1L2 && (layer1_ == 1) && (layer2_ == 2)) || (doL2L3 && (layer1_ == 2) && (layer2_ == 3)) ||
          (doL3L4 && (layer1_ == 3) && (layer2_ == 4)) || (doL5L6 && (layer1_ == 5) && (layer2_ == 6)) ||
          (doD1D2 && (disk1_ == 1) && (disk2_ == 2)) || (doD3D4 && (disk1_ == 3) && (disk2_ == 4)) ||
          (doL1D1 && (disk1_ == 1) && (layer2_ == 1)) || (doL2D1 && (disk1_ == 1) && (layer2_ == 2)) ||
          (doL1D1 && (disk2_ == 1) && (layer1_ == 1)) || (doL2D1 && (disk2_ == 1) && (layer1_ == 2))))
      return;
    ...
    if (disk2_ == 1 && (layer1_ == 1 || layer1_ == 2)) {
        ...
        for (int ibin = start; ibin <= last; ibin++) {
          if (debug1)
            cout << getName() << " looking for matching stub in bin " << ibin << " with "
                 << outervmstubs_->nVMStubsBinned(ibin) << " stubs" << endl;
      ...
      for (unsigned int i = 0; i < innervmstubs_->nVMStubs(); i++) {
        ...
        if ((layer1_ == 1 && layer2_ == 2) || (layer1_ == 2 && layer2_ == 3) || (layer1_ == 3 && layer2_ == 4) ||
            (layer1_ == 5 && layer2_ == 6)) {
          int lookupbits = (int)innervmstub.vmbits().value();
          ...
          for (int ibin = start; ibin <= last; ibin++) {
            for (unsigned int j = 0; j < outervmstubs_->nVMStubsBinned(ibin); j++) {
              ...
              if (print) {
                cout << "Allstub index : " << innervmstub.stubindex().value() << " " << outervmstub.stubindex().value()
                     << endl;
              }
              ...
              if (print) {
                cout << "innerphibits_ outerphibits_ : " << innerphibits_ << " " << outerphibits_ << endl;
                cout << "phitable_.size():" << phitable_.size() << endl;
                cout << "phitable index: " << phitable_[index] << " " << index << " " << iphiinnerbin.value() << " "
                     << iphiouterbin.value() << endl;
              }
        ...
        } else if ((disk1_ == 1 && disk2_ == 2) || (disk1_ == 3 && disk2_ == 4)) {
          if (debug1)
    ...
    if (countall > 5000) {
      cout << "In TrackletEngine::execute : " << getName() << " " << innervmstubs_->nVMStubs() << " "
           << outervmstubs_->nVMStubs() << " " << countall << " " << countpass << endl;
      for (unsigned int i = 0; i < innervmstubs_->nVMStubs(); i++) {
        std::pair<Stub*, L1TStub*> innerstub = innervmstubs_->getVMStubTE(i).stub();
        cout << "In TrackletEngine::execute inner stub : " << innerstub.second->r() << " " << innerstub.second->phi()
             << " " << innerstub.second->r() * innerstub.second->phi() << " " << innerstub.second->z() << endl;
      }
      for (unsigned int i = 0; i < outervmstubs_->nVMStubs(); i++) {
        std::pair<Stub*, L1TStub*> outerstub = outervmstubs_->getVMStubTE(i).stub();
        cout << "In TrackletEngine::execute outer stub : " << outerstub.second->r() << " " << outerstub.second->phi()
             << " " << outerstub.second->r() * outerstub.second->phi() << " " << outerstub.second->z() << endl;
      }
    }
  ...
  void setVMPhiBin() {
    ...
    if ((disk1_ == 1 && disk2_ == 2) || (disk1_ == 3 && disk2_ == 4)) {
