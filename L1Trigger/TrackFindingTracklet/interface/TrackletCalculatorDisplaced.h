...
public:
  TrackletCalculatorDisplaced(string name, unsigned int iSector) : ProcessBase(name, iSector) {
  ...
  void addDiskProj(Tracklet* tracklet, int disk) {
    ...
    if (fpgar.value() * krprojshiftdisk < 12.0)
      return;
    if (fpgar.value() * krprojshiftdisk > 112.0)
      return;
    ...
    if (abs(disk) == 1) {
      if (iphi == 0)
        addProjectionDisk(disk, iphi, trackletproj_D1PHI1_, tracklet);
      if (iphi == 1)
        addProjectionDisk(disk, iphi, trackletproj_D1PHI2_, tracklet);
      if (iphi == 2)
        addProjectionDisk(disk, iphi, trackletproj_D1PHI3_, tracklet);
      if (iphi == 3)
        addProjectionDisk(disk, iphi, trackletproj_D1PHI4_, tracklet);
    }

    if (abs(disk) == 2) {
      if (iphi == 0)
        addProjectionDisk(disk, iphi, trackletproj_D2PHI1_, tracklet);
      if (iphi == 1)
        addProjectionDisk(disk, iphi, trackletproj_D2PHI2_, tracklet);
      if (iphi == 2)
        addProjectionDisk(disk, iphi, trackletproj_D2PHI3_, tracklet);
      if (iphi == 3)
        addProjectionDisk(disk, iphi, trackletproj_D2PHI4_, tracklet);
    }

    if (abs(disk) == 3) {
      if (iphi == 0)
        addProjectionDisk(disk, iphi, trackletproj_D3PHI1_, tracklet);
      if (iphi == 1)
        addProjectionDisk(disk, iphi, trackletproj_D3PHI2_, tracklet);
      if (iphi == 2)
        addProjectionDisk(disk, iphi, trackletproj_D3PHI3_, tracklet);
      if (iphi == 3)
        addProjectionDisk(disk, iphi, trackletproj_D3PHI4_, tracklet);
    }

    if (abs(disk) == 4) {
      if (iphi == 0)
        addProjectionDisk(disk, iphi, trackletproj_D4PHI1_, tracklet);
      if (iphi == 1)
        addProjectionDisk(disk, iphi, trackletproj_D4PHI2_, tracklet);
      if (iphi == 2)
        addProjectionDisk(disk, iphi, trackletproj_D4PHI3_, tracklet);
      if (iphi == 3)
        addProjectionDisk(disk, iphi, trackletproj_D4PHI4_, tracklet);
    }

    if (abs(disk) == 5) {
      if (iphi == 0)
        addProjectionDisk(disk, iphi, trackletproj_D5PHI1_, tracklet);
      if (iphi == 1)
        addProjectionDisk(disk, iphi, trackletproj_D5PHI2_, tracklet);
      if (iphi == 2)
        addProjectionDisk(disk, iphi, trackletproj_D5PHI3_, tracklet);
      if (iphi == 3)
        addProjectionDisk(disk, iphi, trackletproj_D5PHI4_, tracklet);
    }
  }
  ...
  bool addLayerProj(Tracklet* tracklet, int layer) {
    ...
    if (layer == 1) {
      if (iphi == 0)
        addProjection(layer, iphi, trackletproj_L1PHI1_, tracklet);
      if (iphi == 1)
        addProjection(layer, iphi, trackletproj_L1PHI2_, tracklet);
      if (iphi == 2)
        addProjection(layer, iphi, trackletproj_L1PHI3_, tracklet);
      if (iphi == 3)
        addProjection(layer, iphi, trackletproj_L1PHI4_, tracklet);
      if (iphi == 4)
        addProjection(layer, iphi, trackletproj_L1PHI5_, tracklet);
      if (iphi == 5)
        addProjection(layer, iphi, trackletproj_L1PHI6_, tracklet);
      if (iphi == 6)
        addProjection(layer, iphi, trackletproj_L1PHI7_, tracklet);
      if (iphi == 7)
        addProjection(layer, iphi, trackletproj_L1PHI8_, tracklet);
    }

    if (layer == 2) {
      if (iphi == 0)
        addProjection(layer, iphi, trackletproj_L2PHI1_, tracklet);
      if (iphi == 1)
        addProjection(layer, iphi, trackletproj_L2PHI2_, tracklet);
      if (iphi == 2)
        addProjection(layer, iphi, trackletproj_L2PHI3_, tracklet);
      if (iphi == 3)
        addProjection(layer, iphi, trackletproj_L2PHI4_, tracklet);
    }

    if (layer == 3) {
      if (iphi == 0)
        addProjection(layer, iphi, trackletproj_L3PHI1_, tracklet);
      if (iphi == 1)
        addProjection(layer, iphi, trackletproj_L3PHI2_, tracklet);
      if (iphi == 2)
        addProjection(layer, iphi, trackletproj_L3PHI3_, tracklet);
      if (iphi == 3)
        addProjection(layer, iphi, trackletproj_L3PHI4_, tracklet);
    }

    if (layer == 4) {
      if (iphi == 0)
        addProjection(layer, iphi, trackletproj_L4PHI1_, tracklet);
      if (iphi == 1)
        addProjection(layer, iphi, trackletproj_L4PHI2_, tracklet);
      if (iphi == 2)
        addProjection(layer, iphi, trackletproj_L4PHI3_, tracklet);
      if (iphi == 3)
        addProjection(layer, iphi, trackletproj_L4PHI4_, tracklet);
    }

    if (layer == 5) {
      if (iphi == 0)
        addProjection(layer, iphi, trackletproj_L5PHI1_, tracklet);
      if (iphi == 1)
        addProjection(layer, iphi, trackletproj_L5PHI2_, tracklet);
      if (iphi == 2)
        addProjection(layer, iphi, trackletproj_L5PHI3_, tracklet);
      if (iphi == 3)
        addProjection(layer, iphi, trackletproj_L5PHI4_, tracklet);
    }

    if (layer == 6) {
      if (iphi == 0)
        addProjection(layer, iphi, trackletproj_L6PHI1_, tracklet);
      if (iphi == 1)
        addProjection(layer, iphi, trackletproj_L6PHI2_, tracklet);
      if (iphi == 2)
        addProjection(layer, iphi, trackletproj_L6PHI3_, tracklet);
      if (iphi == 3)
        addProjection(layer, iphi, trackletproj_L6PHI4_, tracklet);
    }
  ...
  void addProjection(int layer, int iphi, TrackletProjectionsMemory* trackletprojs, Tracklet* tracklet) {
    if (trackletprojs == 0) {
      if (warnNoMem) {
        cout << "No projection memory exists in " << getName() << " for layer = " << layer << " iphi = " << iphi + 1
             << endl;
      }
      return;
    }
  ...
  void addProjectionDisk(int disk, int iphi, TrackletProjectionsMemory* trackletprojs, Tracklet* tracklet) {
    if (trackletprojs == 0) {
      ...
      if (warnNoMem) {
        cout << "No projection memory exists in " << getName() << " for disk = " << abs(disk) << " iphi = " << iphi + 1
             << endl;
      }
      return;
    }
  ...
  bool LLLSeeding(Stub* innerFPGAStub,
                  ...
                  L1TStub* outerStub) {
    if (debug1) {
      cout << "TrackletCalculatorDisplaced " << getName() << " " << layer_
           << " trying stub triplet in layer (L L L): " << innerFPGAStub->layer().value() << " "
           << middleFPGAStub->layer().value() << " " << outerFPGAStub->layer().value() << endl;
    }
    ...
    //now binary
    double krinv = kphi1 / kr * pow(2, rinv_shift), kphi0 = kphi1 * pow(2, phi0_shift), kt = kz / kr * pow(2, t_shift),
           kz0 = kz * pow(2, z0_shift), kphiproj = kphi1 * pow(2, SS_phiL_shift),
           kphider = kphi1 / kr * pow(2, SS_phiderL_shift), kzproj = kz * pow(2, PS_zL_shift),
           kzder = kz / kr * pow(2, PS_zderL_shift), kphiprojdisk = kphi1 * pow(2, SS_phiD_shift),
           kphiderdisk = kphi1 / kr * pow(2, SS_phiderD_shift), krprojdisk = kr * pow(2, PS_rD_shift),
    ...
    if (debug1)
      if (keep && !keepapprox)
        cout << "TrackletCalculatorDisplaced::LLLSeeding tracklet kept with exact phicrit cut but not approximate, "
                "phicritapprox: "
             << phicritapprox << endl;
    if (usephicritapprox) {
      if (!keep)
    ...
    for (unsigned int i = 0; i < toR_.size(); ++i) {
      ...
      if (izproj[i] < -(1 << (nbitszprojL123 - 1)))
        continue;
      if (izproj[i] >= (1 << (nbitszprojL123 - 1)))
        continue;
      ...
      if (rproj_[i] < 60.0) {
        ...
        if (iphiproj[i] >= (1 << nbitsphistubL123) - 1)
          iphiproj[i] = (1 << nbitsphistubL123) - 2;  //-2 not to hit atExtreme
      } else {
    ...
    if (writeTrackletPars) {
      ...
      out << "Trackpars " << layer_ << "   " << rinv << " " << rinvapprox << " " << rinvapprox << "   " << phi0 << " "
          << phi0approx << " " << phi0approx << "   " << t << " " << tapprox << " " << tapprox << "   " << z0 << " "
          << z0approx << " " << z0approx << endl;
    }

    Tracklet* tracklet = new Tracklet(innerStub,
                                      middleStub,
                                      outerStub,
                                      innerFPGAStub,
                                      middleFPGAStub,
    ...
    if (debug1) {
      cout << "TrackletCalculatorDisplaced " << getName() << " Found LLL tracklet in sector = " << iSector_
           << " phi0 = " << phi0 << endl;
    }
  ...
  bool DDLSeeding(Stub* innerFPGAStub,
    ...
    if (debug1) {
      cout << "TrackletCalculatorDisplaced " << getName() << " " << layer_
           ...
           << middleFPGAStub->disk().value() << " " << outerFPGAStub->disk().value() << endl;
    }
    ...
    if (debug1)
      if (keep && !keepapprox)
        cout << "TrackletCalculatorDisplaced::DDLSeeding tracklet kept with exact phicrit cut but not approximate, "
                "phicritapprox: "
             << phicritapprox << endl;
    if (usephicritapprox) {
      if (!keep)
    ...
    if (debug1) {
      cout << "TrackletCalculatorDisplaced " << getName() << " Found DDL tracklet in sector = " << iSector_
           << " phi0 = " << phi0 << endl;
    }
  ...
  bool LLDSeeding(Stub* innerFPGAStub,
    ...
    if (debug1) {
      cout << "TrackletCalculatorDisplaced " << getName() << " " << layer_
           ...
           << outerFPGAStub->layer().value() << " " << innerFPGAStub->disk().value() << endl;
    }
    ...
    if (debug1)
      if (keep && !keepapprox)
        cout << "TrackletCalculatorDisplaced::LLDSeeding tracklet kept with exact phicrit cut but not approximate, "
                "phicritapprox: "
             << phicritapprox << endl;
    if (usephicritapprox) {
      if (!keep)
    ...
    if (debug1) {
      cout << "TrackletCalculatorDisplaced " << getName() << " Found LLD tracklet in sector = " << iSector_
           << " phi0 = " << phi0 << endl;
    }
  ...
  void exactproj(double rproj,
    ...
    if (debug1)
      cout << "exact proj layer at " << rproj << " : " << phiproj << " " << zproj << "\n";
  }
  ...
  void exactprojdisk(double zproj,
    ...
    if (debug1)
      cout << "exact proj disk at" << zproj << " : " << phiproj << " " << rproj << "\n";
  }
