...
if __name__ == '__main__':
  ...
  for pdg in [1,2,13]:
    ...
    for sample in ['TTbarCL','TTbar']:
      if pdg == 13:
        for ptRange in ['L','H']:
          compareResolution("resVsEta_phi_"+ptRange,sample,ptRange,pdg,maxY=0.03, legPosition='topright')
          compareResolution("resVsEta_z0_"+ptRange,sample,ptRange,pdg,maxY=1, legPosition='topright')
          compareResolution("resVsEta_ptRel_"+ptRange,sample,ptRange,pdg,maxY=0.5, legPosition='topright')
          compareResolution("resVsEta_eta_"+ptRange,sample,ptRange,pdg,maxY=0.015, legPosition='topright')

          compareResolution("resVsPt2_phi",sample,ptRange,pdg,maxY=0.03, legPosition='topright')
          compareResolution("resVsPt2_z0",sample,ptRange,pdg,maxY=1, legPosition='topright')
          compareResolution("resVsPt2_ptRel",sample,ptRange,pdg,maxY=0.5, legPosition='topright')
          compareResolution("resVsPt2_eta",sample,ptRange,pdg,maxY=0.015, legPosition='topright')
        ...
        compareResolution("resVsEta_phi",sample,0,pdg,maxY=0.03, legPosition='topright')
        compareResolution("resVsEta_z0",sample,0,pdg,maxY=1, legPosition='topright')
        compareResolution("resVsEta_ptRel",sample,0,pdg,maxY=0.5, legPosition='topright')
        compareResolution("resVsEta_eta",sample,0,pdg,maxY=0.015, legPosition='topright')
        compareResolution("resVsPt2_phi",sample,0,pdg,maxY=0.03, legPosition='topright')
        compareResolution("resVsPt2_z0",sample,0,pdg,maxY=1, legPosition='topright')
        compareResolution("resVsPt2_ptRel",sample,0,pdg,maxY=0.5, legPosition='topright')
        compareResolution("resVsPt2_eta",sample,0,pdg,maxY=0.015, legPosition='topright')
  ...
  for sample, pdg in samplePdg.iteritems():
    for ptRange in ['L','H']:
      ...
      if ptRange == 'H' and pdg == 11:
          ...
          compareResolution("resVsPt2_ptRel",sample,ptRange,pdg,legPosition='topright')
      elif ptRange == 'H':
